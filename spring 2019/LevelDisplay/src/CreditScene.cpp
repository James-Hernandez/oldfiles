...
CreditScene::CreditScene(SceneLoader *loader)
{
    //ctor
    this->loader = loader;
...
int CreditScene::winMsg(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    switch(uMsg){
        case WM_KEYDOWN:
            {
        ...
        case WM_LBUTTONDOWN:
        {
            ...
            //    GLScene* crediteScene = new CreditScene(loader);
