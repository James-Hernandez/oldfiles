...
/// had to rewrite the texture coordinates because the pictures would be inverted and i didnt want invert all of my images.
...
void Maze::drawChest()
{
    ...
    glBegin(GL_QUADS);
     ...
     spin +=0.5;// this will give speed on how fast the object will turn
    }
}
int Maze::MS(int x)///remember to come back here to tinker with
{
    if(x == 1)
        return 8;
    else if(x == 2)
